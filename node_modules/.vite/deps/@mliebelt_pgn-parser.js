...
var require_index_umd = __commonJS({
  "node_modules/@mliebelt/pgn-parser/lib/index.umd.js"(exports, module) {
    (function(global2, factory) {
      typeof exports === "object" && typeof module !== "undefined" ? factory(exports) : typeof define === "function" && define.amd ? define(["exports"], factory) : (global2 = typeof globalThis !== "undefined" ? globalThis : global2 || self, factory(global2.PgnParser = {}));
      ...
      (function(module2) {
        (function(root, factory) {
          ...
          function peg$parse(input, options) {
            ...
            var peg$f85 = function(res) {
              return res;
            };
            var peg$f86 = function(v) {
              return v;
            };
            ...
            var peg$f91 = function(e) {
              return e;
            };
            var peg$f92 = function(eg) {
              return [eg];
            };
            var peg$f93 = function(cf, c) {
              return c;
            };
            var peg$f94 = function(cf, cfl) {
              return merge([cf].concat(cfl));
            };
            var peg$f95 = function() {
              return;
            };
            var peg$f96 = function(cm) {
              return cm;
            };
            var peg$f97 = function(cm) {
              return { comment: cm };
            };
            var peg$f98 = function(cf, ic) {
              return ic;
            };
            var peg$f99 = function(cf, tail) {
              return merge([{ colorFields: cf }].concat(tail[0]));
            };
            var peg$f100 = function(ca, ic) {
              return ic;
            };
            var peg$f101 = function(ca, tail) {
              return merge([{ colorArrows: ca }].concat(tail[0]));
            };
            var peg$f102 = function(cc, cv, ic) {
              return ic;
            };
            var peg$f103 = function(cc, cv, tail) {
              var ret = {};
              ret[cc] = cv;
              return merge([ret].concat(tail[0]));
            };
            var peg$f104 = function(cc, cv, ic) {
              return ic;
            };
            var peg$f105 = function(cc, cv, tail) {
              var ret = {};
              ret[cc] = cv;
              return merge([ret].concat(tail[0]));
            };
            var peg$f106 = function(ev, ic) {
              return ic;
            };
            var peg$f107 = function(ev, tail) {
              var ret = {};
              ret["eval"] = parseFloat(ev);
              return merge([ret].concat(tail[0]));
            };
            var peg$f108 = function(ac, val, ic) {
              return ic;
            };
            var peg$f109 = function(ac, val, tail) {
              var ret = {};
              ret[ac] = val.join("");
              return merge([ret].concat(tail[0]));
            };
            var peg$f110 = function(c, ic) {
              return ic;
            };
            ...
            var peg$f112 = function(ch) {
              return ch;
            };
            var peg$f113 = function(ch) {
              return ch;
            };
            var peg$f114 = function(cm) {
              return cm.join("");
            };
            ...
            var peg$f118 = function(col, ff, ft) {
              return col + ff + ft;
            };
            ...
            var peg$f134 = function(hm, s1, s2, millis) {
              let ret = s1;
              if (!hm) {
            ...
            var peg$f135 = function(hm, s1, s2) {
              let ret = s1;
              if (!hm) {
                addMessage({ message: `Hours and minutes missing` });
              } else {
            ...
            var peg$f136 = function(hours, minutes) {
              if (!minutes) {
            ...
            var peg$f139 = function(d) {
              return d;
            };
            var peg$f140 = function(vari, all) {
              var arr = all ? all : [];
              arr.unshift(vari);
              return arr;
            };
            var peg$f141 = function(num) {
              return num;
            };
            var peg$f142 = function(digits) {
              return makeInteger(digits);
            };
            var peg$f143 = function() {
              return "";
            };
            var peg$f144 = function(fig, disc, str, col, row, pr, ch) {
              var hm = {};
              hm.fig = fig ? fig : null;
            ...
            var peg$f145 = function(fig, cols, rows, str, col, row, pr, ch) {
              var hm = {};
              hm.fig = fig ? fig : null;
            ...
            var peg$f146 = function(fig, str, col, row, pr, ch) {
              var hm = {};
              hm.fig = fig ? fig : null;
              hm.strike = str ? str : null;
              hm.col = col;
            ...
            var peg$f149 = function(fig, col, row) {
              var hm = {};
              hm.fig = fig;
              hm.drop = true;
              hm.col = col;
            ...
            var peg$f153 = function(f) {
              return "=" + f;
            };
            var peg$f154 = function(nag, nags) {
              var arr = nags ? nags : [];
              arr.unshift(nag);
              return arr;
            };
            var peg$f155 = function(num) {
              return "$" + num;
            };
